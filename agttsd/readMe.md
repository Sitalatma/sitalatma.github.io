...
About 90% of the text is plain paragraphs, with one paragraph being one line in *\*.txt* files. Remaining 10% are indicated in *\*.txt* files with the following markup at the begining of each line:
